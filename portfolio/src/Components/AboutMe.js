    ...
    <section id='about' className='scroll-mt-8'>
      ...
      <div className='lg:px-15 lg:text-lg p-8 md:p-10 border space-y-3 rounded-xl bg-gray-50 shadow-md hover:shadow-xl hover:transition dark:text-gray-200 dark:bg-slate-700 dark:border-slate-700'>
        ...
        <p>
          ...
          I fell in love with front-end while learning HTML, CSS, JavaScript, and other front-end technologies, so I learned more about the front-end world and wanted to pursue front-end web development as a software engineer.
        </p>
        <p>
