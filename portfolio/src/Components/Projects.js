...
const projects = [
  ...
  },
  {
    ...
    desc: [
      "Designed and developed a user-friendly custom mechanical keyboard e-commerce website, which features a list of mechanical keyboard parts, a nested page routing system that allows users to navigate to specific product pages, and a shopping cart system that allows users to add, decrease, and remove products from their cart.",
      "Successfully created a fully functional web application that allows users to browse and shop for mechanical keyboard parts.",
    ],
    img: `${ecommerce}`,
  ...
  },
  {
    ...
    desc: [
      "Developed a RuneScape hiscores tracking and analysis website for a double experience competition of a RuneScape clan.",
      "Built an API to track player information and experience gains over time, utilizing cron jobs to periodically consume the RuneScape API and store cleaned data in a Mongodb database.",
      "Utilized data calculations within the database to output results into the API, which was then consumed by the front-end to display the results on the website.",
      "Tracked over 100 players and performing data calculations to output results every 4 hours.",
    ],
    img: `${etk_dxp}`,
  ...
  return (
    <section id="projects" className="scroll-mt-8 dark:text-gray-200">
      ...
      <div className="grid grid-cols-1 gap-4">
        ...
        None! Practicing leetcode... Portfolio rework soon &trade;
      </div>
