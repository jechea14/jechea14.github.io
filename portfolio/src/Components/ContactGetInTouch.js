...
const ContactGetInTouch = () => {
  return (
    <div className='md:flex-auto border rounded-md px-8 py-4 bg-gray-100 space-y-6 shadow-md hover:shadow-xl hover:transition dark:bg-slate-800 dark:border-slate-800'>
