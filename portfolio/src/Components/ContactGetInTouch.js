...
const ContactGetInTouch = () => {
  return (
    <div className='md:flex-auto border rounded-md py-4 bg-gray-100 space-y-6 shadow-md hover:shadow-xl hover:transition dark:bg-slate-800 dark:border-slate-800'>
        <div className='space-y-2 px-5'>
            <h2 className='text-lg font-medium'>Get in Touch</h2>
            <div className='flex items-center space-x-8 border rounded-md pl-4 pr-1 py-4 bg-gray-50 shadow-md dark:bg-slate-700 dark:border-slate-700'>
