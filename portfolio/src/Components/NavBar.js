...
const NavBar = () => {
  ...
  return (
    <nav className='dark:bg-slate-900 sticky top-0 bg-gray-100 border-b-2 px-7 md:px-28 flex justify-between py-4 items-center w-full 2xl:px-0 dark:border-b-slate-700'>
