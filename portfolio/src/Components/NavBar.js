...
const NavBar = () => {
  ...
  return (
    <nav className='dark:bg-slate-900 sticky top-0 border-b-2 bg-gray-100 px-5 md:px-28 flex justify-between py-4 items-center 2xl:px-0 dark:border-b-slate-700'>
