...
const Intro = () => {
  return (
    <section id='home' className='md:flex md:flex-row-reverse md:justify-around mb-20 lg:justify-center scroll-mt-20 dark:text-gray-200 md:space-x-2'>
      {/* picture */}
      <picture className='flex justify-center mt-4'>
        <img src={self_image} alt='self' loading='lazy' className='rounded-full w-72 md:w-auto h-auto max-w-md md:max-h-72' />
      </picture>
      ...
      <div className='flex flex-col text-center md:text-left md:justify-end'>
        ...
        <div className='flex justify-between mt-10'>
          <button className='bg-purple-600 hover:bg-purple-800 text-gray-100 py-1 px-5 rounded transition dark:hover:text-purple-700 dark:hover:bg-gray-200'>
            <a href={`#projects`} className='text-md lg:text-xl capitalize hover:cursor-pointer  '>Explore My Work</a>
          </button>
          <button>
